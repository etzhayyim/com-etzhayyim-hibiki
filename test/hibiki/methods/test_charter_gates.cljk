(ns hibiki.methods.test-charter-gates
  ...
  `lex/presentation.edn` is the canonical structured EDN lexicon. Nested definitions are
  collections rather than encoded strings."
